...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT order_id, customer_order, order_date FROM order_summary WHERE order_id = ? LIMIT 0,1";
        ...
        if ($_POST) {
            try {
                ...
                $query = "UPDATE order_summary
                  ...
                  order_date=:order_date WHERE order_id = :order_id";
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}"); ?>" method="post">
            <table class='table table-hover table-responsive table-bordered'>
                <tr>
                    ...
                    <td><textarea name='customer_order' class='form-control'><?php echo htmlspecialchars($customer_order, ENT_QUOTES);  ?></textarea></td>
                </tr>
                <tr>
                    <td>order_date</td>
